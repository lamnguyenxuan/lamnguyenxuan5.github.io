...
let showItemExtra = $('#product-list-extra');
let productsExtra = [
    {
        id: 1,
        img: '../image/product-hl1.png',
    ...
    {
        id: 3,
        img: '../image/product-hl3.jpg',
        nameProduct: 'Bơ Đăk Lắk',
        price: '12,000 đ',
        miniTitle: 'Rau hữu cơ',
        discount: '30%',
        imgs: ['../image/product-main.png', '../image/product-1.jpg', '../image/product-2.jpg', '../image/product-3.jpg'],
...
const setLocal1 = (index) =>{
    ...
    console.log('productsExtra[index] :>> ', productsExtra[index]);
    let item = productsExtra[index];
...
productsExtra.forEach((item, index)=>{
    showItemExtra.append(`
    <li class="product-item">
        <a onclick = setLocal1(${index})><img src="${item.img}" alt=""></a>
        <div class="product-info">
            <a onclick = setLocal1(${index}) class="title-product">${item.nameProduct}</a>
...
productsMain.forEach((item, index)=>{
    showItemMain.append(`
